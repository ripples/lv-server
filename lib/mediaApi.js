...
/**
 * GET lv-media/course/lectures/media
 * @param {String} semester - semester
 * @param {string} courseName - course name
 * @param {string} lectureName - lecture name
 * @param {function} callback - callback result, called as callback(err, result)
 */
function getLectureMediaData(semester, courseName, lectureName, callback) {
  const options = Object.assign(OPTIONS, {
    path: `${semester}/${courseName}/${lectureName}/media`
  });
...
module.exports = {
  ...
  getLectureMediaData: getLectureMediaData
};
